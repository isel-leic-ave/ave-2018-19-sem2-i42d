...
//hashSet.Contains(book2): True  // PROBLEM: for the user, book with this ISBN was already removed from the hashset

// 2.
//firstBook  = [Book: Isbn = 0201914670, HashCode = 1441600692]
//secondBook = [Book: Isbn = 0201914670, HashCode = 1441600692]
//objects are equal
//Insert book1 = True, insert book2 = False  // OK
...
//hashSet.Remove(book1) -> True
//hashSet.Contains(book1): False
//hashSet.Contains(book2): True // Hash set transparently manages collisions
