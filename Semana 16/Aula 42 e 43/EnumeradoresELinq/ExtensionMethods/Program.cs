...
public class Global {
	...
	public static IEnumerable<FileInfo> GetDirectoryEnumerator(DirectoryInfo di)
	{
		...
		{
			foreach (FileInfo fi in GetDirectoryEnumerator(childDi)) 
                yield return fi;
		}
	}
	...
	{
        DirectoryInfo di = new DirectoryInfo("/home/nuno/Nuno/ISEL/Ensino/Ano 18-19/Verao/AVE/LI41N/AulasPrep/Semana 16/Aula 43/EnumeradoresELinq");
